...
public class OnboardingProcessWorkers {
    ...
    public void createAccount(ActivatedJob activatedJob) {
        var onboardingRequest = activatedJob.getVariablesAsType(CamundaProcessVariables.class).getOnboardingRequest();
        ...
        if (amountOfCreditCards > 10) {
            ...
            var creditCards = IntStream.rangeClosed(0, amountOfCreditCards)
    ...
    public void createCreditCard(ActivatedJob activatedJob) {
        var camundaProcessVariables = activatedJob.getVariablesAsType(CamundaProcessVariables.class);
        var owner = camundaProcessVariables.getCreditCardInput().owner();
        var expirationDate = LocalDate.now().plusYears(10);
        var number = "1234-5678-9876-000" + camundaProcessVariables.getLoopCounter();
